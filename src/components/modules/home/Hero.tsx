...
const HeroSection = () => {
    return (
        <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-background pt-10 sm:pt-10 pb-12 md:pt-4">
            ...
            <div className="container mx-auto px-6">
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    ...
                    <div className="relative z-10 space-y-8 text-center lg:text-left">
                        ...
                        <h1 className="text-5xl font-extrabold leading-[1.1] tracking-tight sm:text-6xl xl:text-7xl">
                            ...
                            <span className="relative inline-block">
                                <span className="bg-linear-to-r from-primary via-purple-500 to-indigo-600 bg-clip-text text-transparent">
                                    Expert Mentors
                                </span>
                                <svg
                    ...
                    <div className="relative lg:ml-auto group mt-4">
                        ...
                        <div className="relative aspect-square w-full max-w-125 mx-auto lg:max-w-none pt-7">
                            <div className="absolute inset-0 bg-linear-to-tr from-primary/20 to-purple-500/20 rounded-3xl blur-2xl group-hover:scale-105 transition-transform duration-700" />
